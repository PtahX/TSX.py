                        ...
                        if float(dToE) < 100:
                            ...
                            if float(priceSales) < 1:
                                ...
                                if currentPrice < grahamNum:
                                    ...
                                    print(
                                        "\t" + ('Price to Earnings Ratio for') + "\t" + str(stock) + "\t" + str(
                                            priceEarn))
                                    print("\t" + ('Price to Earnings Growth (PEG 5 year) between 0 and 1') + "\t" + str(
                                        stock) + "\t" + str(PEG))
                                    print("\t" + ('Current Ratio greater than 1.9') + "\t" + str(stock) + "\t" + str(
                                        cRatio))
                                    print("\t" + ('Debt to Equity Ratio is less than 100') + "\t" + str(
                                        stock) + "\t" + str(
                                        dToE))
